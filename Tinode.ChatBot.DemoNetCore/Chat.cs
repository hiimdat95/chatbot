                ...
                try
                {
                    ...
                    using (var scope = serviceprovider.CreateScope())
                    {
                        ...
                        if (msg.IsPlainText)
                        {
                            ...
                            //    }
                            //};
                            if (msg.Text.ToLower().Contains("độ tuổi"))
                            {
                                responseText = "<p>-        Nhật Bản: " +

"•        Độ tuổi tuyển dụng: từ 19 đến 27 tuổi(đối với LĐ đi Nhật Bản) ngoài ra tùy thuộc vào đơn hàng đặc biệt có thể tuyển dụng độ tuổi cao hơn." +

"•        Đối với LĐ Nam: Cao từ 165cm trở lên.Nặng: 55kg trở lên" +

"•        Đối với lao động Nữ: Cao từ 150 trở lên, Nặng: 42kg </ p > ";
                            }
                            if (msg.Text.ToLower().Contains("đối tượng"))
                            {
                                responseText = "<p> - Là công dân Việt Nam có nguyện vọng đi làm việc tại nước ngoài mà trong độ tuổi Công ty có nhu cầu tuyển dụng (phải đảm bảo đủ 18 tuổi trở lên, Công ty không tuyển những người dưới 18 tuổi tính đủ theo ngày sinh)" +
...
"Nếu chi tiêu tiết kiệm hợp lý thì sau 3 năm chăm chi làm việc về nước bạn có thể tiết kiệm được từ 600.000.000VNĐ - 800.000.000VNĐ.Đây là số tiền không hề nhỏ để bạn có thể làm ăn, trang trải cuộc sống.</ p > ";
                            }
